...
public enum PaletteColor: String, CaseIterable, Codable {
    ...
    var localizedName: String {
        ...
        case .orange:
            return NSLocalizedString("color.orange", comment: "Orange")
        case .yellow:
            return NSLocalizedString("color.yellow", comment: "Yellow")
        case .green:
            return NSLocalizedString("color.green", comment: "Green")
        case .teal:
            return NSLocalizedString("color.teal", comment: "Teal")
        case .blue:
            return NSLocalizedString("color.blue", comment: "Blue")
        case .indigo:
            return NSLocalizedString("color.indigo", comment: "Indigo")
        case .purple:
            return NSLocalizedString("color.purple", comment: "Purple")
        case .pink:
            return NSLocalizedString("color.pink", comment: "Pink")
        case .gray:
            return NSLocalizedString("color.gray", comment: "Gray")
        }
    }
}
